package com.josesiyo_robbio.kitten_adoption.kitten.dto;
...
public class KittenDto
{
    ...
    public KittenDto(Long id, String name, String breed, String description, String photo, Boolean adopted, int age)
    {
        this.id = id;
        this.name = name;
        this.age = age;
